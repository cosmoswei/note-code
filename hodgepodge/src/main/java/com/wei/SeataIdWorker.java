...
public class SeataIdWorker {
     ...
     */
    public SeataIdWorker(Long workerId) {
    ...
    public static void main(String[] args) {
        SeataIdWorker seataIdWorker = new SeataIdWorker(341L);
        long l = System.currentTimeMillis();
        IntStream.range(1, 100_000_000).forEach(e -> {
            seataIdWorker.nextId();// 2447
//            System.out.println(idWorker.nextId());
        });

        long end = System.currentTimeMillis();
        System.out.println((end - l) / 1000 + "s");
