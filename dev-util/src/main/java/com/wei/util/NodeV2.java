...
public class NodeV2 implements Comparable<NodeV2> {
    ...
    public NodeV2(String ip, Integer weight) {
        this.ip = ip;
        this.weight = weight;
    ...
    public NodeV2(String ip, Integer weight, Integer effectiveWeight, Integer currentWeight) {
        this.ip = ip;
        this.weight = weight;
    ...
    @Override
    public int compareTo(NodeV2 node) {
