package com.wei.async.wrapper;

import com.wei.async.callback.DefaultCallback;
import com.wei.async.callback.ICallback;
import com.wei.async.callback.IWorker;
import com.wei.async.exception.SkippedException;
import com.wei.async.executor.timer.SystemClock;
import com.wei.async.worker.DependWrapper;
import com.wei.async.worker.ResultState;
import com.wei.async.worker.WorkResult;
